...
define('IPL_CORE_API_VERSION', 							"1.5.7");
            ...
            foreach ($xml->allowed_methods[0]->payment_method as $pam)
            {
                ...
                if(isset($pam->additional_data[0]->rate_options[0]))
                {
                    ...
                    foreach ($pam->additional_data[0]->rate_options[0]->tagChildren as $rate_info)
                    {
                        ...
                        $array_aditional_data[$term]['calculation'] =$array_calculation ;
                        $array_aditional_data[$term]['dues'] =$array_dues ;


                    }
                    $array['aditional_data'] = $array_aditional_data;
                    $data['_rate_info']= $array_aditional_data;
                }
