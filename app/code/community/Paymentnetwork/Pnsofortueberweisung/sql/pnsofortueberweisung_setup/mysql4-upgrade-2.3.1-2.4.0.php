...
try {
    $installer->run("
    	UPDATE core_config_data SET `value` = 0 where `path` like 'payment/sofort/sofortvorkasse_active';
		UPDATE core_config_data SET `value` = 0 where `path` like 'payment/sofort/sofortlastschrift_active';
    ");
} catch ( Exception $e ){
