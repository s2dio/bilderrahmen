...
Product.Config.prototype = {
    initialize: function(config,count,type){
        this.config     = config;
        this.count = (count==null)?'':count;
        this.type = (type==null)?'':type;
        this.taxConfig  = this.config.taxConfig;
        this.settings   = $$('.super-attribute-select'+this.count);
        this.state      = new Hash();
...
//      Calculator.updatePrice();
    ...
    reloadPrice: function(){
        ...
        if(optionsPrice.length == null){
            ...
            optionsPrice[this.type][this.config.productId].changePrice('config', {'price': price, 'oldPrice': oldPrice});
            optionsPrice[this.type][this.config.productId].reload();
        }
